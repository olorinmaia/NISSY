(async () => {
  ...
  try {
    ...
    gcCount('/nissy-loader/basic-dev', 'Loader: basic-dev', true);
  } catch (e) {}
  ...
  nissyLoadingText.textContent = 'Laster inn Basic DEV script-pakke…';
  ...
  const nissyPopupKort = `
    ...
    <div style="margin-top: 10px; padding: 12px; background: #f0f8ff; border-left: 4px solid #4a90e2; border-radius: 4px;">
      ...
      <a href="https://github.com/olorinmaia/NISSY/blob/dev/docs/BASIC.md" target="_blank"
...
<style>* { box-sizing: border-box; } body { font-family: Arial, sans-serif; margin: 0; padding: 14px 16px; background: white; }</style>
  ...
  setTimeout(() => {
    ...
    console.log('✅ Kontrollpanel reorganisert for Basic');
  }, 500);
