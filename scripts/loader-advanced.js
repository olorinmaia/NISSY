(async () => {
  ...
  try {
    ...
    gcScript.onload = () => {
      ...
      window.goatcounter?.count({ path: '/nissy-loader/advanced', title: 'Loader: advanced', event: true });
    };
  ...
  console.log('📦 Laster NISSY Advanced (GitHub)...');
  ...
  const nissyPopupKort = `
    ...
    <div style="margin-top: 10px; padding: 12px; background: #f0f8ff; border-left: 4px solid #4a90e2; border-radius: 4px;">
      ...
      <a href="https://github.com/olorinmaia/NISSY/blob/main/docs/ADVANCED.md" target="_blank"
