(async () => {
  ...
  nissyLoadingText.textContent = 'Laster inn AMK script-pakke…';
  ...
  console.log('📦 Laster NISSY AMK (GitHub)...');
  ...
  const nissyPopupKort = `
    ...
    <div style="margin-top: 10px; padding: 12px; background: #f0f8ff; border-left: 4px solid #4a90e2; border-radius: 4px;">
      ...
      <a href="https://github.com/olorinmaia/NISSY/blob/main/docs/AMK.md" target="_blank"
  ...
  (() => {
    ...
    function addHeaderButton() {
      ...
      helpBtn.href = 'https://github.com/olorinmaia/NISSY/blob/main/docs/AMK.md';
